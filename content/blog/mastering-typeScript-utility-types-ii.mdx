...
If you recall in [Part 1](https://manuj-sankrit-8055.vercel.app/blog/mastering-typeScript-utility-types-i), we covered the basics—`Record`, `NonNullable`, `Pick`, and `Omit`. The "sculptors" that help us shape our types.
...
**In next and last part of this series we will cover:**
