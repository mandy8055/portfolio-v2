...
export const mdxComponents = {
  code: ({ children, className, ...props }: ComponentProps<'code'>) => {
    ...
    const isInline = !className || !className.startsWith('hljs');
    ...
    // For code blocks, preserve highlight.js classes
    return (
  ...
  pre: ({ children, ...props }: ComponentProps<'pre'>) => (
    <pre className='p-4 rounded-lg overflow-x-auto mb-4 text-sm' {...props}>
      {children}
    </pre>
  ),
