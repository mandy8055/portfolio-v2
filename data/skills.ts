...
export const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: "React Native", level: "Advanced", icon: "Smartphone", color: "cyan" },
      ...
      { name: "Framer Motion", level: "Advanced", icon: "Sparkles", color: "pink" },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Docker", level: "Intermediate", icon: "Container", color: "blue" },
      { name: "Git", level: "Advanced", icon: "GitBranch", color: "orange" },
      { name: "GitHub Actions", level: "Intermediate", icon: "GitCommit", color: "gray" },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "React Testing Library", level: "Advanced", icon: "FlaskConical", color: "red" },
      { name: "Web Performance", level: "Expert", icon: "Gauge", color: "green" },
    ],
  },
  {
